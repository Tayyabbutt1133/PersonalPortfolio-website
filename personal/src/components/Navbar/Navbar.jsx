    ...
    <div>
      <nav className=" dark:bg-gray-900 py-4">
        <div className=" max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          <a
            href=""
            class="logo text-white text-5xl flex items-center space-x-3 rtl:space-x-reverse"
          >
           TBS
          </a>
          <button
          ...
          <div className="hidden w-full md:block md:w-auto" id="navbar-default">
            ...
            <ul class="font-medium text-sm flex flex-col p-4 md:p-0 mt-4 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 ">
